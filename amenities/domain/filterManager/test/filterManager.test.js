...
describe("Testing filters", () => {
  ...
  const mockMoreThanOne = jest.fn(() => {
    let duplicatedPacks = new Set([
      {
        items: [{ nombre: "uno" }, { nombre: "item2" }, { nombre: "tres" }],
        nombre: "Pack2",
        precio: 70,
        stock: 7,
      },
...
const testPacks = new Set([
  ...
  },
  {
    ...
    stock: 5,
    items: new Set([
      { nombre: "tres", stock: 5, precio: 200 },
      { nombre: "item2", stock: 89, precio: 200 },
      { nombre: "item3", stock: 7, precio: 600 },
      { nombre: "item2", stock: 89, precio: 0 },
      { nombre: "item3", stock: 7, precio: 0 },
    ]),
    precio: 850,
  },
  {
    ...
    stock: 5,
    items: new Set([
      { nombre: "item1", stock: 5, precio: 2000 },
      { nombre: "item2", stock: 89, precio: 2000 },
      { nombre: "item3", stock: 7, precio: 6000 },
    ]),
    precio: 8500,
  },
  {
    ...
    stock: 3,
    items: new Set([
      { nombre: "item1", stock: 3, precio: 20000 },
      { nombre: "item2", stock: 89, precio: 20000 },
      { nombre: "item3", stock: 7, precio: 60000 },
      { nombre: "item3", stock: 7, precio: 0 },
    ]),
    precio: 85000,
  },
